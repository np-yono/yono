...
describe Grape::Endpoint do
  ...
  describe '#headers' do
    ...
    it 'includes requests headers' do
      get '/headers'
    ...
    it 'includes additional requests headers' do
  ...
  describe '#redirect' do
    ...
    it 'has status code 303 if it is not get requests and it is http 1.1' do
      subject.post('/hey') do
        redirect '/ha'
      end
    ...
    it 'notifies AS::N' do
      ...
      expect(@events).to contain_exactly(
        ...
        have_attributes(name: 'endpoint_run_validators.grape', payload: {endpoint: a_kind_of(Grape::Endpoint),
                                                                         validators: [],
                                                                         requests: a_kind_of(Grape::Request) }),
        have_attributes(name: 'endpoint_run_filters.grape', payload: { endpoint: a_kind_of(Grape::Endpoint),
                                                                       filters: [],
