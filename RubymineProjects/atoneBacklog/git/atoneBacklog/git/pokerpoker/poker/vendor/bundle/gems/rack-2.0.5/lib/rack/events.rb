...
module Rack
  ### This middleware provides hooks to certain places in the requests /
  ...
  # The events are:
  #
  # * on_start(requests, response)
  #
  #   This event is sent at the start of the requests, before the next
  #   middleware in the chain is called.  This method is called with a requests
  ...
  #   called with a requests object and the response object.  The response
  ...
  #   a requests object and the response object.  The response object is
