...
module Grape
  module DSL
    module InsideRoute
      ...
      # End the requests and display an error to the
      ...
      #
      # @param status [Integer] The HTTP Status Code to return for this requests.
      ...
      # Returns route information for the current requests.
      #
      # @example
      #
